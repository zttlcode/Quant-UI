      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-8 mb-16">
        <GlassCard variant="subtle" className="p-6">
          ...
          <div className="space-y-3 text-sm text-terminal-muted leading-relaxed">
            ...
            <p>
              在此基础上，我们集成了<strong className="text-quant-cyan">深度时间序列模型</strong>（Deep Time Series Models）
              作为核心推理引擎，基于清华大学的 <a href="https://github.com/thuml/Time-Series-Library" target="_blank" rel="noopener noreferrer" className="text-quant-cyan underline underline-offset-2 hover:text-quant-green transition-colors">Time-Series-Library</a>，
              涵盖 Transformer、Autoformer、TimesNet、Informer、PatchTST、iTransformer 等多种前沿架构，
              实现对市场时序模式的高精度建模与预测。
            </p>
          </div>
        </GlassCard>
          ...
          <div className="space-y-4">
            <div className="p-4 rounded-xl bg-quant-cyan/5 border border-quant-cyan/10">
              ...
              <p className="text-xs text-terminal-muted">
                ...
                （止盈/止损/时间三重屏障）进行标签化训练，最终由深度时序模型推理产生交易信号。
              </p>
            </div>
            <div className="p-4 rounded-xl bg-purple-500/5 border border-purple-500/10">
              ...
              <p className="text-xs text-terminal-muted">
                ...
                高效搜索最优策略配置，最终由深度时序模型进行信号层面的推理与决策。
              </p>
            </div>
          </div>
        </GlassCard>
      ...
      <GlassCard variant="subtle" className="p-6 mb-16">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            { category: 'AI / ML', items: ['Deep Time Series', 'PyTorch', 'Meta-labeling', 'Bayesian Opt'] },
