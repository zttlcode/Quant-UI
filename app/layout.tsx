...
export const metadata: Metadata = {
  ...
  description: '基于 Meta-labeling + Deep Time Series Models 的人工智能量化交易研究平台，覆盖 A 股/港股/美股/数字币四大市场，实时监控策略表现与市场行情',
}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-terminal-muted text-sm leading-relaxed">
              所有数据来自公开数据平台，数据每个交易日下午17:30更新。实际交易可能因市场流动性、滑点等因素产生差异。
            </p>
          </div>
          <div>
